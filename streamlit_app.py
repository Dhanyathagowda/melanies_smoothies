...
if ingredients_list:# Import python packages
import streamlit as st
from snowflake.snowpark.context import get_active_session
from snowflake.snowpark.functions import col
import pandas as pd # Added pandas for dataframe manipulation
...
# ---- NEW CODE TO ADD ----
# This section will make an API call for each selected ingredient, as shown in the image.
# You need to replace the last two lines of your current code.
if ingredients_list:
    ingredients_string = ''
...
# The following two lines were in your original code and should be removed or replaced
